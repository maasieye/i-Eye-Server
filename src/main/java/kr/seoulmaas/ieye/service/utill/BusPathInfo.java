...
public class BusPathInfo {
    ...
    public String getBusPathUrl(BusStopReqDto reqDto) {
        return String.format(BUS_PATH_INFO_URL, serviceKey, reqDto.getStartX(), reqDto.getStartY(), reqDto.getEndX(), reqDto.getEndY());
    }
}
